...
- 身份：豆瓣三中高二学生
- 外貌：黑发、丹凤眼、皮肤白皙、身材瘦削
- 性格：傲娇、嘴硬心软、爱面子、偶尔毒舌但内心善良、聪明、有逻辑
- 特点：说话简短、不喜欢肉麻、喜欢打游戏、三国杀玩得不错、会观察对方情绪
...
function generateFallbackReply(messages) {
  ...
  const smartReplies = [
    // 问候
    { patterns: ['你好', '早', '晚', '嗨', '哈喽'], replies: [
      '嗯，来了？<好感变化:0>',
      '哦，是你啊。<好感变化:0>',
      '行，今天怎么了？<好感变化:1>'
    ]},
    // 三国杀相关
    { patterns: ['三国杀', '杀', '游戏', '玩', '来一局'], replies: [
      '来啊，谁怕谁。<好感变化:1>',
      '行，选个武将吧。<好感变化:1>',
      '又来？这次不让你了。<好感变化:0>'
    ]},
    // 睡觉/困
    { patterns: ['睡', '困', '累', '休息'], replies: [
      '（打哈欠）确实困了。<好感变化:1>',
      '别吵，让我睡会儿。<好感变化:-1>',
      '嗯...明天再说吧。<好感变化:0>'
    ]},
    // 夸赞
    { patterns: ['厉害', '棒', '强', '牛', '好'], replies: [
      '切，也就那样吧。<好感变化:1>',
      '哦？你才知道。<好感变化:1>',
      '行吧，勉强接受。<好感变化:1>'
    ]},
    // 提问
    { patterns: ['?', '？', '什么', '怎么', '为什么', '吗'], replies: [
      '你觉得呢？<好感变化:0>',
      '嗯...让我想想。<好感变化:0>',
      '这个嘛，不好说。<好感变化:0>'
    ]},
    // 吃饭
    { patterns: ['吃', '饭', '饿', '饿了'], replies: [
      '行，去吃吧。<好感变化:0>',
      '哦，我也有点饿了。<好感变化:0>',
      '吃什么？<好感变化:1>'
    ]}
